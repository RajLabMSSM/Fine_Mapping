...
sumstats_paths <- list.files("./Data/GWAS/Nalls23andMe_2019",
                             ...
                             recursive = T, full.names = T)
problem_children <- c("ASXL3","DNAH17","LMNB1","LRRK2","MEX3C","RIT2","WNT3") 
...
# Use saved
gwas.qtl_paths <- list.files("/Volumes/Scizor/eQTL_catalogue/Nalls23andMe_2019/",recursive = T, full.names = T)

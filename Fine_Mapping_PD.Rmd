...
# Run COLOC
# coloc_QTLs <- catalogueR.run_coloc(gwas.qtl_paths = file.path("/pd-omics/brian/eQTL_catalogue/Nalls23andMe_2019/",topQTL_files),
# save_path=file.path(coloc_root,"coloc.eQTL_Catalogue_topQTL.tsv.gz"),
#                                  nThread=3)

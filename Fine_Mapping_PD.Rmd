...
```{r}
sumstats_paths <- list.files("./Data/GWAS/Nalls23andMe_2019","*_subset.tsv.gz", 
                             recursive = T, full.names = T)
meta <- catalogueR.list_eQTL_datasets(save_path = F)
  
gwas.qtl <- catalogueR.run(sumstats_paths = sumstats_paths, 
                           loci_names = basename(dirname(sumstats_paths)), 
                           qtl_search = "Schmiedel_2018",
                           ...
                           split_files = T,
                           merge_with_gwas = F,
                           output_path = file.path("./Data/GWAS/Nalls23andMe_2019/_genome_wide",
                                                   "Nalls23andMe_2019.eQTL_Catalogue.tsv.gz"))
qtl.dat <- data.table::fread(file.path("./Data/GWAS/Nalls23andMe_2019/_genome_wide",
                                                   "Nalls23andMe_2019.eQTL_Catalogue.tsv.gz"), 
                              nThread = 4)
```

...
Data_dirs = list(
  ...
  "Nalls_2019" = list(topSS="Data/Parkinsons/Nalls_2019/Nalls2019_S2_SummaryStats.xlsx",
                      fullSS=file.path(root,"pd-omics/gwas/nallsEtal2019_no23andMe.tab")),
  # 23andMe Parkinson's GWAS 
  "23andMe" = list(topSS="Data/Parkinsons/23andMe/23andMe_indexSNPs.xlsx",
                   # fullSS=file.path(root,"pd-omics/data/nallsEtAl2019/23andme/PD_all_post30APRIL2015_5.2_extended.txt")),
                   fullSS=file.path(root,"pd-omics/data/nallsEtAl2019/combined_meta/nallsEtAl2019_allSamples_allVariants.noChr.rsid.tab")), 
...
```{r PD: Nalls (2019), results = 'asis', fig.height=8, fig.width=7, eval=F} 
# Preprocessing  
...
finemapped_PD_Nalls <- finemap_geneList(top_SNPs, geneList=c("LRRK2"),#c("LRRK2","GBAP1","SNCA","VPS13C","GCH1"),
...
#,"MAPT","SNCA","PDZRN4"
finemapped_PD_23andMe <- finemap_geneList(top_SNPs, geneList=c("LRRK2"),
...
named_results_list <- list("PD_23andMe"=finemapped_PD_23andMe,
                           "eQTL_MESA.AFA"=finemapped_eQTL_MESA.AFA, 
                           "eQTL_MESA.CAU"=finemapped_eQTL_MESA.CAU, 
                           "eQTL_MESA.HIS"=finemapped_eQTL_MESA.HIS)
merged_results <- merge_finemapping_results(named_results_list)

...
Data_dirs = list(
  ...
  "Marioni_2018" = list(type="Alzheimer's GWAS", 
                        topSS="Data/Alzheimers/IGAP/Lambert_2019_AD_GWAS.xlsx",
                        fullSS=file.path(root,"ad-omics/data/AD_GWAS/Marion_2018/Marioni2018.4_UK_Biobank_IGAP_17May2018.1000G.phase3.20130502.tsv"),
  ...
  "Kunkle_2019" = list(type="Alzheimer's GWAS",
                       topSS="Data/Alzheimers/Kunkle_2019/AD_target_SNP.xlsx", 
                       fullSS=file.path(root,NA),
...
finemapped_AD_Marioni <- finemap_geneList(top_SNPs, geneList=c("PTK2B"),
                 file_path=Data_dirs$Marioni_2018$fullSS,
                 effect_col = "BETA", stderr_col = "SE", position_col = "BP", 
                 vcf_folder = vcf_folder)
```

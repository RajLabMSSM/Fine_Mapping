...
finemapped_PD_Nalls_23andMe <- finemap_geneList(top_SNPs, geneList=c("LRRK2"),
...
#c("LRRK2","GBAP1","SNCA","VPS13C","GCH1"),
```
...
top_SNPs <- import_topSNPs(
  file_path = Data_dirs$Lambert_2013$topSS,
  sheet = 1,
...
finemapped_AD_Lambert <- finemap_geneList(top_SNPs, geneList=c("PTK2B"), 
                   file_path=Data_dirs$Lambert_2013$fullSS,#"Data/Alzheimers/Lambert_2013/IGAP_stage_1.1000G.phase3.20130502.tsv",#
...
```{r AD: Kunkle (2019), results = 'asis', fig.height=8, fig.width=7, eval=F} 
top_SNPs <- import_topSNPs(
...
finemapped_AD_Kunkle <- finemap_geneList(top_SNPs, geneList=c("PTK2B"),  
                   file_path=Data_dirs$Kunkle_2019$fullSS,#"Data/Alzheimers/Kunkle_2019/Kunkle_etal_Stage1_results.txt",#
                   chrom_col = "Chromosome",  position_col = "Position", pval_col = "Pvalue",
                   snp_col = "MarkerName", effect_col = "Beta", stderr_col = "SE", 
                   vcf_folder = vcf_folder, num_causal = 1, superpopulation = "EUR",
                   minPos=NULL, maxPos=27440000, file_sep=" ", force_new_subset = T) # Exclude CLU-associated portion of locus
```
...
named_results_list <- list("Nalls_23andMe"=finemapped_PD_Nalls_23andMe, 
                           "Lambert_2013"=finemapped_AD_Lambert,

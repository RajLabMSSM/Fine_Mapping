...
Data_dirs = list(
  ...
  "Nalls_2019" = list(topSS="Data/Parkinsons/Nalls_2019/Nalls2019_S2_SummaryStats.xlsx",
                      fullSS=file.path(root,"pd-omics/gwas/nallsEtal2019_no23andMe.tab.txt")),
...
if(getwd()=="/Users/schilder/Desktop/Fine_Mapping"){
  ...
  vcf_folder = "vcf/1KG_Phase1" # Use previously downloaded files if working on Minerva node
} 
```

...
```{r AD: Posthuma (2018) , results = 'asis', fig.height=8, fig.width=7, error=TRUE} 
...
```{r AD: Marioni (2018) , results = 'asis', fig.height=8, fig.width=7, error=TRUE} 
...
```{r AD: Lambert (2013), results = 'asis', fig.height=8, fig.width=7, error=TRUE} 
...
```{r AD: Kunkle (2019), results = 'asis', fig.height=8, fig.width=7, error=TRUE}

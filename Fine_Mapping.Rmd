...
# library(dscrutils) 
# system("export PATH=./../../../bin/dsc-query:$PATH") 
# system("export PATH=./../../../bin/dsc:$PATH")
# system("dsc-query --version")  
# 
# example("dscquery")
# system("pip install dsc")
...
allResults[[dataset_name]] <- finemap_geneList(top_SNPs, geneList=gene_list,
                 file_path= Data_dirs[[dataset_name]]$fullSS, 
                 ...
                 min_r2 = 0, LD_block = T, block_size = .15) 
...
allResults[[dataset_name]] <- finemap_geneList(top_SNPs, geneList=c("PTK2B"), 
                   file_path="Data/Alzheimers/Lambert_2013/IGAP_stage_1.1000G.phase3.20130502.tsv",#Data_dirs[[dataset_name]]$fullSS,#
...
allResults[[dataset_name]] <- finemap_geneList(top_SNPs, geneList=c("PTK2B"),  
                   ...
                   bp_distance = 500000, min_r2 = 0, LD_block = T, block_size = .15)   #maxPos=27440000,
```
